...
namespace Disaster_demo.Controllers
{
    ...
    public class AidRequestController : ControllerBase
    {
        ...
        [HttpGet("pending")]
        public async Task<IActionResult> GetPendingAidRequests([FromQuery] string gnDivision)
        {
            ...
            var result = await _aidrequestServices.getPendingAidRequests(gnDivision);
            return Ok(result);
        }
